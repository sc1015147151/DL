...
def Deeplabv3(weights=None, input_tensor=None, input_shape=(256, 256, 4), classes=2, backbone='xception', OS=16, alpha=1.):
...
if __name__ == '__main__':
    ...
    plot_model(m, show_shapes=True, to_file='Deeplab3P.png')
